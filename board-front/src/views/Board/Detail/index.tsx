    ...
    return (
      <div id='board-detail-top'>
        <div className='board-detail-top-header'>
          ...
          <div className='board-detail-top-sub-box'>
            <div className='board-detail-write-info-box'>
              ...
              <div className='board-detail-writer-nickname'>{'사람1'}</div>
              <div className='board-detail-info-divider'>{'\|'}</div>
              <div className='board-detail-write-date-time'>{'2024-06-03'}</div>
            </div>
        ...
        <div className='board-detail-top-main'>
          <div className='board-detail-main-text'>{'뭐먹어야 할까?뭐먹어야 할까?뭐먹어야 할까?뭐먹어야 할까?뭐먹어야 할까?뭐먹어야 할까?'}</div>
          <img className='board-detail-main-image' src={`https://flexible.img.hani.co.kr/flexible/normal/960/960/imgdb/resize/2019/0121/00501111_20190121.JPG`}/>
        </div>
      </div>
    );
  };
